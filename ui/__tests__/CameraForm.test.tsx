...
describe('CameraForm', () => {
  ...
  it('calls onSave with correct data when form is valid', () => {
    ...
    fireEvent.changeText(getByPlaceholderText('Camera Password'), 'password123');
  ...
  it('toggles detection settings correctly', () => {
    ...
    fireEvent(getByTestId('inactivity-detection-all-day'), 'onValueChange', true);
