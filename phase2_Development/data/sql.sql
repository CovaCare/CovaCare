...
--     inactivity_detection_start_time TIME, -- Start time for inactivity detection active hours
--     inactivity_detection_end_time   TIME, -- End time for inactivity detection active hours
